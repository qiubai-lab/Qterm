...
pub enum ApplicationErrorCode {
    ...
    ProfileStorageClearRejected,
    ProfileStorageUnavailable,
    SshConfigNotFound,
    SshConfigUnreadable,
    SshConfigTooLarge,
    SshConfigInvalid,
    SshConfigImportSelectionInvalid,
    InvalidNetworkRule,
    ...
    ClipboardImageEncodingFailed,
    ClipboardImageSftpUnavailable,
    ClipboardImageTemporaryDirectoryUnavailable,
    ClipboardImageUploadFailed,
    InvalidTransferPath,
...
impl From<AuthFailure> for ApplicationError {
    fn from(failure: AuthFailure) -> Self {
        match failure {
            ...
            AuthFailure::KeyGenerationFailed => Self::new(
                ApplicationErrorCode::PrivateKeyGenerationFailed,
                "无法生成私钥，请重试",
                true,
            ),
