---
id: QB-20260818-qterminal-titlebar-brand
status: archived
archived: 2026-09-02
legacy: true
---
...
Superseded in part on 2026-08-18 by `docs/qb-spec/archive/2026/QB-20260818-inline-workspace-rename/spec.md`：品牌文本随后缩短为 `Qterm`；右侧窗口控件与拖动规则继续有效。
