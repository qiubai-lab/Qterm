...
Superseded in part on 2026-08-18 by `docs/qb-spec/archive/2026/QB-20260818-flat-workspace-tabs/spec.md`：Terminal Block、工具轨和布局能力保留，Workspace Switcher 与内部 Tab 层已由顶部 Workspace 标签取代。
