---
id: QB-20260818-wave-workspace-foundation
status: archived
archived: 2026-09-02
legacy: true
---
...
Completed on 2026-08-18; navigation model later superseded by `docs/qb-spec/archive/2026/QB-20260818-flat-workspace-tabs/spec.md`. 多会话 runtime、全屏 shell、工具弹窗和 Block 布局能力继续保留，Workspace Switcher 与内部 Tab 已移除。
...
- `docs/qb-spec/archive/2026/QB-20260818-wave-workspace-foundation/spec.md`：完成状态和偏差。
